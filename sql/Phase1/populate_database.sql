...
INSERT INTO Employee (FirstName, LastName, EmployeeRole, ManagerID, StartDate, AddressID, Phone, Email)
VALUES
('Alice', 'Anderson','Manager', NULL, '2025-01-10', 1, '416-555-1235', 'aliceanderson@email.com'),
('Bob', 'Taylor','Manager', 1, '2025-02-15', 2, '604-555-2346', 'bobtaylor@email.com'),
('Charlie', 'Wilson','Manager', NULL, '2025-03-20', 3, '403-555-3457', 'charliewilson@email.com'),
('Deborah', 'Martinez','Manager', 1, '2025-04-25', 4, '514-555-4568', 'deborahmartinez@email.com'),
('Ethan', 'Lewis','Manager', NULL, '2025-05-30', 5, '613-555-5679', 'ethanlewis@email.com'),
('Fiona', 'Young','Manager', 3, '2025-06-10', 6, '780-555-6780', 'fionayoung@email.com'),
('George', 'Walker','Manager', 2, '2025-07-15', 7, '416-555-7891', 'georgewalker@email.com'),
('Hannah', 'Scott','Manager', 4, '2025-08-20', 8, '604-555-8902', 'hannahscott@email.com'),
('Isla', 'Roberts','Manager', NULL, '2025-09-10', 9, '403-555-9013', 'islaroberts@email.com'),
('Jack', 'Adams','Manager', 3, '2025-09-25', 10, '613-555-0124', 'jackadams@email.com'),
('Karen', 'Ng','Loan Officer', 1, DATEADD(DAY, -120, GETDATE()), 11, '416-555-2231', 'karen.ng@email.com'),
('Liam', 'Ford','Loan Officer', 1, DATEADD(DAY, -115, GETDATE()), 12, '604-555-2232', 'liam.ford@email.com'),
('Nora', 'Chavez','Personal Banker', 3, DATEADD(DAY, -110, GETDATE()), 13, '403-555-2233', 'nora.chavez@email.com'),
('Owen', 'Lam','Loan Officer', 3, DATEADD(DAY, -105, GETDATE()), 14, '514-555-2234', 'owen.lam@email.com'),
('Piper', 'Singh','Network Admin', NULL, DATEADD(DAY, -100, GETDATE()), 15, '613-555-2235', 'piper.singh@email.com'),
('Quinn', 'Harper','Personal Banker', 5, DATEADD(DAY, -95, GETDATE()), 16, '780-555-2236', 'quinn.harper@email.com'),
('Riley', 'Stone','Loan Officer', 2, DATEADD(DAY, -90, GETDATE()), 17, '416-555-2237', 'riley.stone@email.com'),
('Seth', 'Powell','Network Admin', 4, DATEADD(DAY, -85, GETDATE()), 18, '604-555-2238', 'seth.powell@email.com'),
('Tessa', 'Ward','Loan Officer', 4, DATEADD(DAY, -80, GETDATE()), 19, '403-555-2239', 'tessa.ward@email.com'),
('Uma', 'Kaur','Personal Banker', NULL, DATEADD(DAY, -75, GETDATE()), 20, '613-555-2240', 'uma.kaur@email.com'),
('Victor', 'Roy','Loan Officer', 6, DATEADD(DAY, -70, GETDATE()), 21, '403-555-2241', 'victor.roy@email.com'),
('Wendy', 'Park','Network Admin', 6, DATEADD(DAY, -65, GETDATE()), 22, '250-555-2242', 'wendy.park@email.com'),
('Xavier', 'Bell','Loan Officer', 7, DATEADD(DAY, -60, GETDATE()), 23, '604-555-2243', 'xavier.bell@email.com'),
('Yara', 'Quinn','Teller', 7, DATEADD(DAY, -55, GETDATE()), 24, '604-555-2244', 'yara.quinn@email.com'),
('Zane', 'Abbott','Personal Banker', NULL, DATEADD(DAY, -50, GETDATE()), 25, '807-555-2245', 'zane.abbott@email.com'),
('Amy', 'Cole','Loan Officer', 8, DATEADD(DAY, -45, GETDATE()), 26, '519-555-2246', 'amy.cole@email.com'),
('Brent', 'Fox','Teller', 8, DATEADD(DAY, -40, GETDATE()), 27, '519-555-2247', 'brent.fox@email.com'),
('Cara', 'Gates','Loan Officer', 9, DATEADD(DAY, -35, GETDATE()), 28, '705-555-2248', 'cara.gates@email.com'),
('Drew', 'Hunt','Teller', 9, DATEADD(DAY, -30, GETDATE()), 29, '905-555-2249', 'drew.hunt@email.com'),
('Eve', 'Irwin','Personal Banker', NULL, DATEADD(DAY, -25, GETDATE()), 30, '905-555-2250', 'eve.irwin@email.com'),
('Finn', 'Jade','Loan Officer', 10, DATEADD(DAY, -22, GETDATE()), 31, '403-555-2251', 'finn.jade@email.com'),
('Gia', 'Keane','Teller', 10, DATEADD(DAY, -19, GETDATE()), 32, '250-555-2252', 'gia.keane@email.com'),
('Hugo', 'Lane','Personal Banker', 2, DATEADD(DAY, -16, GETDATE()), 33, '604-555-2253', 'hugo.lane@email.com'),
('Iris', 'Moss','Teller', 3, DATEADD(DAY, -13, GETDATE()), 34, '604-555-2254', 'iris.moss@email.com'),
('Jules', 'Nolan','Loan Officer', 4, DATEADD(DAY, -10, GETDATE()), 35, '705-555-2255', 'jules.nolan@email.com'),
('Kira', 'Ortiz','Loan Officer', 5, DATEADD(DAY, -7, GETDATE()), 36, '705-555-2256', 'kira.ortiz@email.com'),
('Leo', 'Price','Teller', 6, DATEADD(DAY, -5, GETDATE()), 37, '519-555-2257', 'leo.price@email.com'),
('Mila', 'Queen','Teller', 7, DATEADD(DAY, -3, GETDATE()), 38, '905-555-2258', 'mila.queen@email.com'),
('Nate', 'Reese','Loan Officer', 8, GETDATE(), 39, '905-555-2259', 'nate.reese@email.com'),
('Opal', 'Shaw','Loan Officer', 9, GETDATE(), 40, '519-555-2260', 'opal.shaw@email.com');
...
(2, 1), (3, 1),(3, 2), (4, 2), (1, 3), (4, 3),
 (5, 3), (5, 4), (6, 4), (3, 4), (4, 5), (7, 5);
...
(1, 2), (3, 6), (5, 10), (7, 3), (10, 9),
(12, 5), (14, 2), (16, 9), (19, 7), (21, 4),
(25, 6), (28, 10), (30, 8), (33, 1), (36, 5), (38, 9);
...
(1, 1, 4000.00, '2025-10-10', 1.7, DATEADD(MONTH, -3, GETDATE())),
(2, 2, 2500.00, '2025-10-10', 2.3, DATEADD(MONTH, -4, GETDATE())),
(3, 2, 4500.00, '2025-10-10', 1.6, DATEADD(MONTH, -1, GETDATE())),
(4, 1, 6000.00, '2025-10-10', 2.5, GETDATE()),
(5, 2, 7000.00, '2025-10-10', 1.8, GETDATE()),
...
(2, 20000.00, 4.5, GETDATE(), DATEADD(MONTH, 1, GETDATE())),
(3, 30000.00, 4.8, GETDATE(), DATEADD(MONTH, 1, GETDATE())),
(4, 25000.00, 4.2, GETDATE(), DATEADD(MONTH, 1, GETDATE())),
(5, 10000.00, 5.5, GETDATE(), DATEADD(MONTH, 1, GETDATE())),
(1, 15000.00, 5.0, GETDATE(), DATEADD(MONTH, 1, GETDATE())),
(2, 22000.00, 4.7, GETDATE(), DATEADD(MONTH, 1, GETDATE())),
(3, 27000.00, 4.6, GETDATE(), DATEADD(MONTH, 1, GETDATE())),
(4, 28000.00, 5.3, GETDATE(), DATEADD(MONTH, 1, GETDATE())),
(5, 35000.00, 4.9, GETDATE(), DATEADD(MONTH, 1, GETDATE())),
(1, 18000.00, 4.50, DATEADD(MONTH, -3, GETDATE()), DATEADD(MONTH, -2, GETDATE())),
(2, 22000.00, 4.70, DATEADD(MONTH, -2, GETDATE()), DATEADD(MONTH, -1, GETDATE())),
(3, 15000.00, 5.10, DATEADD(MONTH, -1, GETDATE()), DATEADD(MONTH, 0, GETDATE())),
(4, 28000.00, 4.30, DATEADD(MONTH, -4, GETDATE()), DATEADD(MONTH, -3, GETDATE())),
(5, 12500.00, 4.90, DATEADD(MONTH, -3, GETDATE()), DATEADD(MONTH, -2, GETDATE())),
(1, 30000.00, 5.20, DATEADD(MONTH, -2, GETDATE()), DATEADD(MONTH, -1, GETDATE())),
(2, 17000.00, 4.80, DATEADD(MONTH, -1, GETDATE()), DATEADD(MONTH, 0, GETDATE())),
(3, 26000.00, 4.60, DATEADD(MONTH, -4, GETDATE()), DATEADD(MONTH, -3, GETDATE())),
(4, 14000.00, 5.00, DATEADD(MONTH, -3, GETDATE()), DATEADD(MONTH, -2, GETDATE())),
(5, 35000.00, 5.40, DATEADD(MONTH, -2, GETDATE()), DATEADD(MONTH, -1, GETDATE())),
(1, 21000.00, 4.70, DATEADD(MONTH, -1, GETDATE()), DATEADD(MONTH, 0, GETDATE())),
(2, 24000.00, 5.10, DATEADD(MONTH, -4, GETDATE()), DATEADD(MONTH, -3, GETDATE())),
(3, 12000.00, 4.40, DATEADD(MONTH, -3, GETDATE()), DATEADD(MONTH, -2, GETDATE())),
(4, 27000.00, 4.90, DATEADD(MONTH, -2, GETDATE()), DATEADD(MONTH, -1, GETDATE())),
(5, 31000.00, 5.30, DATEADD(MONTH, -1, GETDATE()), DATEADD(MONTH, 0, GETDATE())),
(1, 16000.00, 4.20, DATEADD(MONTH, -4, GETDATE()), DATEADD(MONTH, -3, GETDATE())),
(2, 19500.00, 4.55, DATEADD(MONTH, -3, GETDATE()), DATEADD(MONTH, -2, GETDATE())),
(3, 22000.00, 4.75, DATEADD(MONTH, -2, GETDATE()), DATEADD(MONTH, -1, GETDATE())),
(4, 24500.00, 5.05, DATEADD(MONTH, -1, GETDATE()), DATEADD(MONTH, 0, GETDATE())),
(5, 33000.00, 5.25, DATEADD(MONTH, -4, GETDATE()), DATEADD(MONTH, -3, GETDATE())),
(1, 28500.00, 4.65, DATEADD(MONTH, -3, GETDATE()), DATEADD(MONTH, -2, GETDATE())),
(2, 15500.00, 4.85, DATEADD(MONTH, -2, GETDATE()), DATEADD(MONTH, -1, GETDATE())),
(3, 27500.00, 5.15, DATEADD(MONTH, -1, GETDATE()), DATEADD(MONTH, 0, GETDATE())),
(4, 13500.00, 4.35, DATEADD(MONTH, -4, GETDATE()), DATEADD(MONTH, -3, GETDATE())),
(5, 20000.00, 4.95, DATEADD(MONTH, -3, GETDATE()), DATEADD(MONTH, -2, GETDATE())),
(1, 32000.00, 5.35, DATEADD(MONTH, -2, GETDATE()), DATEADD(MONTH, -1, GETDATE())),
(2, 14500.00, 4.45, DATEADD(MONTH, -1, GETDATE()), DATEADD(MONTH, 0, GETDATE())),
(3, 18500.00, 4.65, DATEADD(MONTH, -4, GETDATE()), DATEADD(MONTH, -3, GETDATE())),
(4, 29500.00, 4.85, DATEADD(MONTH, -3, GETDATE()), DATEADD(MONTH, -2, GETDATE())),
(5, 25000.00, 5.05, DATEADD(MONTH, -2, GETDATE()), DATEADD(MONTH, -1, GETDATE())),
